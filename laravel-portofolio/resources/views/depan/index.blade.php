...
<head>
    ...
    <title>Portofolio- Akhla Alfantera Gallantry</title>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-danger fixed-top" id="sideNav">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="navbar-nav">
                ...
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#interests">Ketertarikan saya</a></li>
                <li class="nav-item"><a class="nav-link js-scroll-trigger" href="#awards">Awards/Penghargaan</a></li>
            </ul>
        </div>
    </nav>
    <!-- Page Content-->
    <div class="container-fluid p-0">
        ...
        <section class="resume-section" id="about">
            <div class="resume-section-content">
                ...
                <div class="social-icons">
                    <a class="social-icon" href="{{ get_meta_value('_instagram') }}">
        ...
        <section class="resume-section" id="skills">
            <div class="resume-section-content">
                ...
                <div class="subheading mb-3">Bahasa dan Tools Pemrograman yang dikuasai</div>
                ...
                <div class="subheading mb-3">Karya yang telah dibuat</div>
